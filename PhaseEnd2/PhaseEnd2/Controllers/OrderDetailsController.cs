...
namespace PhaseEnd2.Controllers
{
    ...
    {
        private readonly PhaseEnd2DbContext _context;

        public OrderDetailsController(PhaseEnd2DbContext context)
        {
            _context = context;
        }
        ...
        {
            var phaseEnd2DbContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
            return View(await phaseEnd2DbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PhaseEnd2DbContext.OrderDetail'  is null.");
            }
            var orderDetail = await _context.OrderDetail.FindAsync(id);
            if (orderDetail != null)
            {
